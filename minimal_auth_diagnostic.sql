-- Minimal diagnostic for auth.users issues
-- Avoids problematic audit log table
...
-- 6. Check if there are any functions that might be failing
SELECT 'Functions that might be called by triggers:' as status;
SELECT 
    routine_name,
    routine_type
