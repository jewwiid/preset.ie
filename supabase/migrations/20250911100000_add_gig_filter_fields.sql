-- Add missing filter fields to gigs table for Browse Gigs functionality
-- This migration adds style_tags, vibe_tags, city, and country fields

-- Add style_tags array to gigs table (similar to users_profile)
ALTER TABLE gigs 
ADD COLUMN IF NOT EXISTS style_tags TEXT[] DEFAULT '{}';

-- Add vibe_tags array to gigs table
ALTER TABLE gigs 
...
-- Add constraint to limit tags per gig
ALTER TABLE gigs 
