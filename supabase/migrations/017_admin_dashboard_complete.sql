-- Complete Admin Dashboard System Migration
-- This combines all admin system tables for easier deployment
...
DO $$
BEGIN
    RAISE NOTICE 'Admin Dashboard Tables Created:';
    RAISE NOTICE '✅ reports table';
    RAISE NOTICE '✅ moderation_actions table';
    RAISE NOTICE '✅ verification_requests table';
    RAISE NOTICE '✅ verification_badges table';
    RAISE NOTICE '✅ user_violations table';
    RAISE NOTICE '✅ violation_thresholds table';
    RAISE NOTICE '';
