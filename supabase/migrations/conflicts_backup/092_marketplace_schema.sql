...
-- =====================================================
-- Migration: 092_marketplace_schema.sql
-- Description: Complete marketplace system for rent & sell functionality
...
VALUES (
    'migration_completed',
    'info',
    'Marketplace schema migration completed successfully',
    '{"migration": "092_marketplace_schema.sql", "tables_created": 8, "indexes_created": 25, "policies_created": 20}'
