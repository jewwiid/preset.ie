-- Admin Dashboard Functions and Views (Fixed)
-- Fixed column references for existing tables
...
-- Create audit view for moderation actions (FIXED - removed r.content_type)
...
-- Create violations dashboard view (FIXED - removed r.content_type)
...
BEGIN
    ...
    RAISE NOTICE 'Database foundation is solid.';
    RAISE NOTICE '';
