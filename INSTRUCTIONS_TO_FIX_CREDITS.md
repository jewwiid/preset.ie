# 🚨 URGENT: Fix Credits Database Error

## Problem
You're getting: `ERROR: 42P01: relation "user_credit_purchases" does not exist`
...
BEGIN
    ...
    INSERT INTO credit_transactions (
        ...
        p_description, p_reference_id, p_metadata
    );
...
After running the SQL, you should see: `Credit tables created successfully! 🎉`

## ✅ What This Fixes
- ✅ Creates all missing credit-related tables
- ✅ Sets up proper permissions and security
- ✅ Creates the credit management function
- ✅ Adds default credit packages
- ✅ Makes the Stripe integration work
- ✅ Enables the user profile credits section

## 🎯 What You Can Do Now
1. **View Credits**: Go to `/profile?tab=credits` 
2. **See Balance**: Credit balance shows in navigation
3. **Purchase Credits**: Use Stripe checkout flow
4. **Track History**: View all transactions

## 🚀 Next: Set Up Stripe
Once the database is fixed, follow the Stripe setup guide in `STRIPE_INTEGRATION_SETUP.md`

---
**This fix is safe to run multiple times** - it uses `IF NOT EXISTS` clauses.