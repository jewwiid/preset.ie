-- Secure verification-documents bucket policies
...
-- Note: You'll need to check your admin identification method
-- This example assumes admins have a specific role or are in a list
