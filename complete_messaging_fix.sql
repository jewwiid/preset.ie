...
-- This will fix all the issues and create proper test data

-- Step 1: Remove constraints that block marketplace messaging
ALTER TABLE messages DROP CONSTRAINT IF EXISTS messages_gig_id_fkey;
ALTER TABLE messages ALTER COLUMN gig_id DROP NOT NULL;

-- Step 2: Fix RLS policies to allow service role access
