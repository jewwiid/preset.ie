-- Final fix for notification_preferences table
-- This ensures the table exists in the correct schema and location

-- First, check if the table exists and drop it if it does
DROP TABLE IF EXISTS notification_preferences CASCADE;

-- Create the notification_preferences table with the exact structure we need
