-- Fixed Initial Schema - Safe Version with Trigger Handling
-- This migration consolidates all core types, tables, and functions without conflicts
-- Includes proper trigger handling to avoid "already exists" errors
...
-- Triggers (with proper DROP IF EXISTS handling)
