-- Final corrected manual admin creation using actual table structures
...
-- Create the user profile using correct column names
...
-- Create user settings using the correct column names
