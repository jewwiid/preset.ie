-- Fix Verification System - Corrected for Existing Schema
...
-- 10. Drop and recreate admin dashboard view with enhanced data (using correct column names)
...
-- Success message
SELECT 'Verification System Fixed Successfully!' as status;
