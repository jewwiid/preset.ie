-- Add Specialized Preset Categories
-- This script adds presets for specialized photography categories beyond just headshots and products
...
SELECT 'Wedding Ceremony Portrait',
       ...
       true, true, 'Wedding Ceremony Portrait'
...
SELECT 'Real Estate Interior',
       ...
       true, true, 'Real Estate Interior'
...
SELECT 'Architecture Exterior',
       ...
       true, true, 'Architecture Exterior'
...
SELECT 'Restaurant Food Photography',
       ...
       true, true, 'Restaurant Food Photography'
...
SELECT 'Wildlife Photography',
       ...
       true, true, 'Wildlife Photography'
...
SELECT 'Landscape Photography',
       ...
       true, true, 'Landscape Photography'
