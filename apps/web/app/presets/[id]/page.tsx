...
const CATEGORIES = {
  ...
  artistic: { label: 'Artistic', icon: '🎨', color: 'bg-pink-100 text-pink-800' },
  portrait: { label: 'Portrait', icon: '👤', color: 'bg-green-100 text-green-800' },
  landscape: { label: 'Landscape', icon: '🏞️', color: 'bg-emerald-100 text-emerald-800' },
