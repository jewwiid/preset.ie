      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            ...
            <br />
            <span className="text-foreground">Connect & Create</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              <>
                <a
                  href="/dashboard"
                  className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-primary-foreground bg-preset-500 rounded-xl overflow-hidden transition-all hover:scale-105"
                >
                ...
                <a
                  href="/gigs/create"
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-preset-600 dark:text-preset-400 bg-background dark:bg-muted-800 rounded-xl border-2 border-preset-200 dark:border-preset-800 hover:border-preset-300 dark:hover:border-preset-600 transition-all"
                >
                  Create a Gig
                </a>
              </>
      ...
      <section id="features" className="py-20 bg-gradient-to-b from-background to-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature Cards */}
            <div className="group relative bg-card rounded-2xl p-8 shadow-lg card-interactive">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">Post & Browse Gigs</h3>
            ...
            <div className="group relative bg-card rounded-2xl p-8 shadow-lg card-interactive">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">In-App Showcases</h3>
              <p className="text-muted-foreground">
            ...
            <div className="group relative bg-card rounded-2xl p-8 shadow-lg card-interactive">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">Safe & Trusted</h3>
              <p className="text-muted-foreground">
            ...
            <div className="group relative bg-card rounded-2xl p-8 shadow-lg card-interactive">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">Beautiful Moodboards</h3>
              <p className="text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {user ? (
              <>
                <a
                  href="/dashboard"
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-preset-600 bg-background rounded-xl hover:shadow-xl transition-all hover:scale-105"
                >
                  Go to Dashboard
                </a>
                <a
                  href="/gigs"
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-primary-foreground border-2 border-border rounded-xl hover-interactive transition-all"
                >
                  Browse Gigs →
                </a>
              </>
