...
function CollaboratePageContent() {
  ...
  const { headerImage } = usePageHeaderImage('collaborate-header');
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <PageHeader
          title="Collaborate"
          subtitle="Connect with creators and bring your projects to life"
          icon={Users}
          stats={[
            { icon: Camera, label: `${projects.length} Active Projects` },
            { icon: Sparkles, label: 'Find Creative Opportunities' }
          ]}
          actions={
