  ...
  if (!stats) {
    return (
      <div className="text-center p-8">
        ...
        <p className="text-gray-500">Unable to load moderation analytics</p>
        <button 
          onClick={fetchStats}
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{stats.pending_items}</p>
            ...
            <div className="flex flex-col items-center">
              ...
              {stats.pending_items > 100 && (
                <span className="text-xs text-red-600 mt-1">High load!</span>
              )}
            </div>
          </div>
        </div>
              ...
              stats.top_flags.slice(0, 6).map((flag) => (
                <div key={flag.flag} className="flex items-center justify-between">
                  <div className="flex items-center gap-3 flex-1">
                    <span className="text-sm text-gray-700 capitalize min-w-0 flex-1">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700">Medium Risk (31-69)</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700">High Risk (70+)</span>
              </div>
              <div className="flex items-center gap-2">
              ...
              <div key={date} className="flex items-center gap-4 py-2">
                ...
                <div className="flex-1 flex items-center gap-2">
                  <div className="flex items-center gap-2 flex-1">
                    <div className="text-xs text-gray-500 w-12">Flagged:</div>
