        ...
        <div className="bg-white shadow-xl rounded-lg p-8">
          ...
          {currentStep === 'profile' && (
            <form onSubmit={handleProfileSubmit} className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Date of Birth * <span className="text-red-500">(Required for age verification)</span>
                </label>
                <div className="relative">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                        {optionsLoading ? (
                          <div className="text-gray-500">Loading equipment options...</div>
                        ) : (
          ...
          {currentStep === 'preferences' && (
            <div className="space-y-6">
              ...
              <div className="border-t pt-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Work Type Preferences</h3>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Accepts TFP (Trade for Portfolio)</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Accepts Expenses Only</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Prefers Studio Work</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Prefers Outdoor Work</span>
                    </label>
                  </div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Works with Teams</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Prefers Solo Work</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Available Weekdays</span>
                    </label>
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Available Weekends</span>
                    </label>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Comfortable with Nudity</span>
                  </label>
                  ...
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Comfortable with Intimate Content</span>
                  </label>
                  ...
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Requires Model Release</span>
                  </label>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-blue-900 mb-3">Profile Visibility</h3>
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center cursor-pointer">
                      <input
                        ...
                        className="mr-2"
                      />
                      <span className="text-sm font-medium text-gray-700">Show Physical Attributes</span>
                    </label>
                  </div>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  ...
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="mr-2"
                    />
                    <span className="text-sm font-medium text-gray-700">Valid Passport (for international travel)</span>
                  </label>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {optionsLoading ? (
                    <div className="text-gray-500">Loading style options...</div>
                  ) : (
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {optionsLoading ? (
                    <div className="text-gray-500">Loading vibe options...</div>
                  ) : (
