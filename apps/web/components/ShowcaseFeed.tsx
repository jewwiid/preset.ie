  ...
  if (showcases.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 mb-4">Be the first to create an amazing showcase!</p>
      </div>
    );
  }
          ...
          <CardContent className="p-4">
            <div className="space-y-3">
              <Link href={`/showcases/${showcase.id}`} className="block">
                <h3 className="font-semibold text-slate-900 line-clamp-1 group-hover:text-purple-600 transition-colors">
                  {showcase.title}
                </h3>
              </Link>
